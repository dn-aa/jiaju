...
export interface ArticleDetail extends ArticleBrief { body?: string | null }
...
// ---------- 首页聚合 ----------
export const getHome = () => http.get('/public/home').then((r) => r.data.data as {
  banners: Banner[]; categories: Category[]; hot_products: ProductBrief[];
  new_cases: CaseBrief[]; news: ArticleBrief[]; steps: { step_no: number; title: string; desc?: string | null }[];
