...
import {
  Button, Card, DatePicker, Form, Input, Modal, Select, Space, Switch, Table, Tag, Popconfirm, message,
} from 'antd';
...
export default function ArticleManage() {
  ...
  return (
    <div>
      ...
      {/* 写文章/编辑 Modal（PRD v2.2 BR-4.2 字段） */}
      <Modal open={modalOpen} title={editing ? `编辑文章 · ${editing.title}` : '写文章'} width={760}
